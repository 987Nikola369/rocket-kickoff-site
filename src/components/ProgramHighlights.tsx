    ...
    <section id="program" className="py-32 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20 animate-slide-up">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Program Highlights</h2>
          <p className="text-gray-300 mt-6 text-lg">Discover what makes our academy unique</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="neo-blur p-8 rounded-xl hover:scale-105 transition-all duration-500 group"
              style={{
